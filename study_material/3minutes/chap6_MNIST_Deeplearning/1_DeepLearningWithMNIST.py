...
class SingleLayerNetwork:
    ...
    def prepare_model(self, num_units):
        ...
        with tf.name_scope('hidden1'):
            w1 = tf.Variable(tf.random_normal([784, num_units]), name='weights')
        ...
        with tf.name_scope('hidden2'):
            w2 = tf.Variable(tf.random_normal([num_units, num_units]), name='weights')
            b2 = tf.Variable(tf.zeros([num_units]), name='biases')
